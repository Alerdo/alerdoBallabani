...
//THIS IS A VERSION USING HTML BUTTON ELEMENT INSDEAT OF LEAFLET EASY BUTTONS
...
// This is the old extra markers logic, meanwhile I try the other ones 
// Populating Cities with clustering
function populateMap(cities) {
    var cityIcon = L.divIcon({
        className: 'city-icon',
